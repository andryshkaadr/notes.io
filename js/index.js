...
function boxGenerator(list) {
    ...
    for (let i = 0; i < list.length; i++) {
        template += '<div class="box" style="left: ' + list[i].x + 'px; top: ' + list[i].y + 'px;" data-index="' + i + '"><textarea class="text" text-index="' + i + '" rows="15" cols="20" placeholder="Note is empty..." >'+list[i].text+'</textarea></div>';
    }
